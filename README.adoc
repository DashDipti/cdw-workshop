...
<iframe src="https://free.timeanddate.com/countdown/i9tbqnog/n776/cf12/cm0/cu4/ct0/cs0/ca0/cr0/ss0/cac000/cpc000/pcfff/tcfff/fs100/szw320/szh135/tatTime%20left%20to%20Event%20in/tac000/tptPage%20will%20be%20updated%20by.../tpc000/mac000/mpc000/iso2025-03-27T00:00:00" allowtransparency="true" frameborder="0" width="180" height="69"></iframe>

<iframe width="100%" height="475" src="https://dotnetfiddle.net/Widget/CsCons" frameborder="0"></iframe>

image::images/dash/landing.png[]


'''

Version : 1.1 `20th March 2025` +
...
//- Go back to the CDP Console and observe the Impala Virtual Warehouse `emerging-impala-1`. +
...
- If you are not seeing the above screenshot and see something like below then click on `Cloudera Data Catalog` on the top left corner. Then click on `Ranger` on top right corner. +
image:images/step6/6-9a.png[] + 
...
- Test the policy is working - Open `HUE` for the CDW Impala Virtual Warehouse - `emerging-impala-1` and execute the following query. +
...
- Now we will create a join between another table. Click on `+` icon next to `flights` as shown below. Select the appropriate `Database Name` based on your <user_id> (Ex: `emerging01_airlines`) and table name `airlines`. +
...
image:images/misc/thankyou1.PNG[] +
