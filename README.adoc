...
(b) `Workshop Login Username`: \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_  (Your Instructor would provide this) +
(c) `Workshop Login Password`: \\\\\\\\\\\\\\\\\\\\____________________ (Your Instructor would provide this) +
(d) `CDP Workload User`:  _____________ (Your Instructor would provide this) +
(e) `CDP Workload Password`: _____________ (You will set it in Step 1(b) of the workshop) +
(f) `Hive Virtual Warehouse Name`: _____________ (Your Instructor would provide this) +
(g) `Impala Virtual Warehouse Name`: _____________ (Your Instructor would provide this) +
(h) `S3 Bucket`: _____________ (Your Instructor would provide this) +
