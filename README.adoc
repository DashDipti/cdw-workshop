...
== Important URLs
1. https://tinyurl.com/2awfrsxa[PKO_Details] - Participants must fill their details here to get associated credentials and resources for the workshop. +
2. http://3.109.161.118/auth/realms/workshop/protocol/saml/clients/samlclient[Workshop login] - Use this URL to authenticate yourself and enter CDP. +
