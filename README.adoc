...
Enter the `Workshop Login Username` and `Workshop Login Password` shared by your instructor. (Note: Note that your username would be something like wuser00@workshop.com and not just wuser00). +
