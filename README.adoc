...
- From the notepad just copy the first value of the timestamp. It could be the date or the timestamp. In our case the value was `2023-04-04 06:51:14.360000000`.
image:images/step5/53-3.png[] +

- From the notepad just copy the second value of the snapshot id. . In our case the value was `6341506406760449831`.
image:images/step5/53-4.png[] +

=== 5.4 Iceberg Rollback [Table Maintenance]  +


=== 5.5 Iceberg Rollback [Table Maintenance] +
