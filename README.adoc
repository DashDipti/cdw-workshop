...
(d) `CDP Workload User`: \____________________ (Your Instructor would provide this) +
(e) `CDP Workload Password`: \_____________________ (*You will* set it in Step 1(b) of the workshop) +
(f) `Hive Virtual Warehouse Name`: \____________________ (Your Instructor would provide this) +
(g) `Impala Virtual Warehouse Name`: \____________________ (Your Instructor would provide this) +
(h) `S3 Bucket`: \____________________ (Your Instructor would provide this) +
