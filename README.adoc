...
===== Lab Setup
You'll will be provided with a Login.  Please enter your details below for reference throughout these lab exercises.
WORKSHOP LOGIN URL: Click Here_____________________________________ 
Must be on VPN
Use Incognito Browser window
Login: 
User (Workload User): _____________________________________
Password: _____________________________________	

The Workshop Admin will provide you with the location where the CSV files are located for the Lab exercises.
S3: 
Bucket: _____________________________________	(ie. s3a://bucket-name)

The Workshop Admin will provide you with the Data Lake name.
Data Lake: 
Data Lake Name: _____________________________________
...
=== Step 1(b): Define Workload Password

Please use the login url: http://3.109.161.118/auth/realms/workshop/protocol/saml/clients/samlclient[Workshop login] Enter the `Username` and `Password` shared by your instructor. (Note: Note that your username would be something like wuser00@workshop.com and not just wuser00). +
