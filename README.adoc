...
2. http://18.216.174.235/realms/master/protocol/saml/clients/cdp-sso[Workshop login] - Using the details in the previous step make sure you are able to login here. +
