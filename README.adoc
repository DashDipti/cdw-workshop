...
In this step you will build a Logistics Dashboard using Cloudera Data Visualization.  The Dashboard will include details about flight delays and cancellations.
...
- Now we will creare join between another table. Click on `+` icon next to `flights` as shown below. Select the appropriate `Database Name` based on your user id (Ex: `wuser00_airlines`) and table name `airlines`. +
...
- Click on `+` icon next to `flights` as shown below. Select the appropriate `Database Name` based on your user id (Ex: `wuser00_airlines`) and table name `airports`. +
...
image:images/step7/31.png[] + 
image:images/step7/32.png[] + 
image:images/step7/33.png[] + 
image:images/step7/34.png[] +
