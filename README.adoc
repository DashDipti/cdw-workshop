...
SELECT * FROM ${user_id}_airlines.airlines_orc WHERE code IN ("UA","XX","PA");


----

The final “SELECT” statement should return the following result - codes “XX” and “PA” were inserted rows, and code “UA” which had its description value changed from “United Air Lines Inc.” to “Adrenaline Airlines”.
